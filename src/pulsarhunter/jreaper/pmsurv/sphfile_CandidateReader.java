...
public class sphfile_CandidateReader implements CandidateReader {
    ...
    public Cand getFromFile(File file,CandScorer scorer) {
        try{
            PulsarFile_sph phfile = new PulsarFile_sph(file);
            phfile.read();
            ...
            pCand = null;
            phfile = null;
            Cand result = new Cand(new PulsarFile_sph(file),period,SNR,DM,accel,jerk,score,mjd);
